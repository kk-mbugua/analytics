...
const (
	PipelineService_GetPipelines_FullMethodName = "/pipelines.PipelineService/GetPipelines"
)
...
var PipelineService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pipelines.PipelineService",
	...
	Metadata: "pkg/proto/pipelines.proto",
}
